from Tome.linepy import *
from Tome.akad.ttypes import Message
from Tome.akad.ttypes import ContentType as Type
from Tome.akad.ttypes import ChatRoomAnnouncementContents
from Tome.akad.ttypes import ChatRoomAnnouncement
...
#===============================================================================#
print ("\n\n『“ ᶜʰᶤᶜʳᶤᶜ”➢✧sᴇʟғʙᴏᴛ✧』\n")
#line = LINE('ExtUYvQokIIa69eyeiN6.Tbay7RenVBLXzxaa09xwjG.Ajrd+1pkYBynerGDFPDJrRql2HKkyfPpsPtGJbkXJG4=')
line = LINE("","")
line.log("Auth Token : " + str(line.authToken))
#channel = Channel(line, line.server.CHANNEL_ID['JUNGEL_PANG'])
#channelToken = channel.getChannelResult()
#carousel = '{}'.format(channelToken.token)
...
RfuBot=[lineMID]
Family=["u4db055855928255a6f53054d0915f196",lineMID]
admin=['u4db055855928255a6f53054d0915f196',lineMID]
...
#    "blacklist":{},
    ...
    "Respontag":"『“ ᶜʰᶤᶜʳᶤᶜ”➢✧sᴇʟғʙᴏᴛ✧",
    "ResponPM":"『“ ᶜʰᶤᶜʳᶤᶜ”➢✧sᴇʟғʙᴏᴛ✧",
    "replyPesan": "Sorry , i'm busy right now.",
    "message":"『“ ᶜʰᶤᶜʳᶤᶜ”➢✧sᴇʟғʙᴏᴛ✧",
    "comment":"『“ ᶜʰᶤᶜʳᶤᶜ”➢✧sᴇʟғʙᴏᴛ✧ ",
    "Wc":"กรุณาตั้งคนเข้า",
    "bye":"กรุณาตั้งคนออก",
    "add":"『“ ᶜʰᶤᶜʳᶤᶜ”➢✧sᴇʟғʙᴏᴛ✧",
...
#==============================================================================#
         ...
         #       if text.lower() == "คำสั่ง":
          ...
          #          link = "https://pa1.narvii.com/6547/d29a5e4bb3405d83fc15cf50ec057f41640618a8_hq.gif"
            #        line.sendFooter(to, myHelp, icon, name, link)
                    ...
                    start = time.time()
                    line.sendMessage(to, "『“ ᶜʰᶤᶜʳᶤᶜ”➢✧sᴇʟғʙᴏᴛ✧』")
...
#===========BOT UPDATE BY NOXTIAN============#
                elif msg.text.lower().startswith("แท็ค2"):
                  if msg._from in admin:						
                    data = msg.text[len("แท็ค2"):].strip()
                    if data == "":
                        group = line.getGroup(msg.to)
...
#==============================================================================#                    
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         settings["add"] = spl
                         line.sendMessage(msg.to, "『“ ᶜʰᶤᶜʳᶤᶜ”➢✧sᴇʟғʙᴏᴛ✧』\nตั้งข้อความตอบโต้เมื่อมีคนแอดแล้ว\n\n[ {} ]".format(str(spl)))
...
#=====================================================================================#
                        ...
                        if settings["checkContact"] == True:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง...\n\n『“ ᶜʰᶤᶜʳᶤᶜ”➢✧sᴇʟғʙᴏᴛ✧』", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
                        else:
                            settings["checkContact"] = True
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดอ่านข้อความคอนแทคภายในห้อง....\n\n『“ ᶜʰᶤᶜʳᶤᶜ”➢✧sᴇʟғʙᴏᴛ✧』", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
...
#===========ชุด API คำสั่งใช้งานบอทสิริเชนวี10 ========================== 
        if op.type == 26:
          ...
          #  if settings ["Aip"] == True:
           # 	if msg.text in ["cleanse","group cleansed.","mulai",".winebot",".kickall","mayhem","kick on","Kick","Kick","กระเด็น","หวด"]:
...
#                    line.sendMessage(msg.to, None, contentMetadata={"STKID":"51626516","STKPKGID":"11538","STKVER":"1"}, contentType=7)
            if settings ["Api"] == True:
                if msg.text in ["อยู่ไหม","เช็คบอท","อย","ออนใหม"]:
